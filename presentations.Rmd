...
- Risikoaversj opptatt av forholdet mellom forventet avkastning (+) og risiko (-)
	- Bedre ut: *Nordvestover* i et diagram med risiko på x-aksen og forventet avkastning på y-aksen
...
\begin{equation}
Kov(r_1,r_2)=\sum_{s=1}^{S}Pr(s)[r_1(s)-E(r_1)][r_2(s)-E(r_2)] \\
Pr(1)[r_1(1)-E(r_1)][r_2(1)-E(r_2)]+\\Pr(2)[r_1(2)-E(r_1)][r_2(2)-E(r_1)]+...+ \\ Pr(S)[r_1(S)-E(r_1)][r_2(S)-E(r_2)] 
\end{equation}
...
**Metode 1**
\begin{equation*}
Var(r_c) =0.2[0.010-0.02]^2+0.5[0.016-0.02]^2+0.3[0.023-0.02]^2=0.001975\\
Std(r_c)=\sqrt{0.001975}=0.044
\end{equation*}
...
- $Kor(r_a,r_b)=1$ (helt avhengige)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
- $Kor(r_a,r_b)=0$ (helt uavhengige)
- $Kor(r_a,r_b)=-1$ (helt motsatt avhengige)
