...
- Større N (dvs. desto flere aksjer i porteføljen), desto mer dominerer porteføljevarianse av $(1-\frac{1}{N})$ framfor $\frac{1}{N}$
- Når $ N \rightarrow \infty $
- Desto lavere $\overline{Kov}$ er i forhold til $\overline{Var}$
