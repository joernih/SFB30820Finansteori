...
tils2 <- c(1350,500,200,50,300,550,440,160,0.42)
tils3 <- c(1350,500,200,50,300,550,440,160,0.42)
tils4 <- c(1350,500,200,50,300,550,440,160,0.42)
df_prosj_kontantstrøm <- data.frame(radnr,tils1,tils2,tils3,tils4)
htmlTable(df_prosj_kontantstrøm, header=c(0,1,2,3,4))
```
---
