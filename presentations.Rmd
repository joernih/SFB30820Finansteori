...
\begin{align}
NV = \sum_{t=0}^{T} \frac{X_{t}}{(1+k)^t} = X_{0} +  \frac{X_{1}}{(1+k)^1} + \frac{X_{2}}{(1+k)^t} + ... + \frac{X_{T}}{(1+k)^T} 
\end{align}
...
\begin{align}
NV = \sum_{t=0}^{T} \frac{X_{t}}{(1+k)^t} = X_{1} \frac{X_{1}}{(1+k)^1} + \frac{X_{2}}{(1+k)^t} + ... + \frac{X_{T}}{(1+k)^T} 
\end{align}
