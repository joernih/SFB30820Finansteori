...
## Måling av risiko (portefølje fra 1 til 2 fonds)

**Metode 1 for måling av risiko**
- Varians
\begin{equation}
Var(X)=\sum_{s=1}^{S}Pr(s)[X(s)-E(X)]^2=\\ Pr(1)[X(1)-E(1)]^2+Pr(2)[X(2)-E(2)]^2+...+\\Pr(s)[X(s)-E(X)]^2
\end{equation}
- Standardavvik
\begin{equation}
Std(X)=\sqrt{Var(X)}
...
**Metode 2 for måling av risiko (2 fonds sammensatt)**
- Varians
\begin{equation}
...
Repetisjon: Ved bruk av metode 1 under første forelesning har vi at $E(r_a)=0.2\cdot 0.16+0.5\cdot 0.12+0.3\cdot 0.06=00.00$ og $E(r_b)=0.2\cdot 0.05+0.5\cdot 0.20+0.3\cdot 0.40=0.00$.

---

Fond **A**
\begin{equation*}
Var(r_a) =0.2[0.016-0.02]^2+0.5[0.016-0.02]^2+0.3[0.016-0.02]^2=0.0013
\end{equation*}

Fond **B**
\begin{equation*}
Var(r_a) =0.2[0.016-0.02]^2+0.5[0.016-0.02]^2+0.3[0.016-0.02]^2=0.0156
\end{equation*}
...
Antar vi at investeringsbeløpet er likt fordelt mellom de to fondene, dvs $w_1=1/2,w_2=1-w_2=1/2$ kan måle risikoen til det sammensate fondet C ved bruk av 2 metoder
...
**Metode 1**
\begin{equation*}
Var(r_c) =0.2[0.016-0.02]^2+0.5[0.016-0.02]^2+0.3[0.016-0.02]^2=0.00716875
\end{equation*}

**Metode 2**
Vi starter først med
\begin{equation*}
Var(r_c) =1/2+1/2+2(1/2)^2=0.00716875
\end{equation*}
Siden vi har at
\begin{equation*}
Cov(r_a,r_b) = 0.2[0.016-0.02][0.016-0.02]+0.5[0.016-0.02][0.016-0.02]+0.3[0.016-0.02][0.016-0.02]=1
\end{equation*}
---

**Øvelse:** Sett opp Excel ....
...
```
`rsum(df_eks_2_1_w$ev)` og `sum(df_eks_2_1_w$wvar)` 
og `sqrt(sum(df_eks_2_1_w$wvar))`
...
Skiller melllom *risiknøytral* og *risikoaversjon* aktør
...
## Endring av samvariasjon og porteføljevekter
...
+ w_a_2Std(1,)Std()Korr(1,) \\
+ w_a_2StdStd(1,)Std()Korr(1,) \\
+ w_a_2StdStd(2,)Std()Korr(1,) 
\end{equation}
---
- Varians n-fonds
\begin{equation}
Var(r_p)=\sum_{i=1}^{N}w_i^2Var(r_i)+\sum_{i=1}^{N}\sum_{i=j}^{N}w_iw_jStd(i)Std(j)Korr(i,j)
\end{equation}
---
