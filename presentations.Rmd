...
Fond **B**
\begin{equation*}
Var(r_b) =0.2[0.05-0.23]^2+0.5[0.016-0.20]^2+0.3[0.016-0.40]^2=0.0156 \\
...
Antar vi at investeringsbeløpet er likt fordelt mellom de to fondene, dvs $w_1=1/2,w_2=1-w_2=1/2$. 
...
# Covarnaise missing
htmlTable(df_eks_2_1_w, header=c("Tilstand","Sansynlighet","A","B", "w_a","w_b","C"))
```

Da kan vi måle risikoen til det sammensate fondet C ved bruk av 2 metoder
