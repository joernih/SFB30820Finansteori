...
filp <- '/inst/forelesningsnotater/presentationsF.Rmd'
...
### Forventet avkastning og total risiko 123
...
mu <- mean(til_u$opa)
mm <- mean(til_m$opa)
su <- 123#round(sd.p(c(til_u$opa)),digits=0)
sm <- 123#round(SFB30820Finansteori::sd.p(c(til_m$opa)),digits=0)
