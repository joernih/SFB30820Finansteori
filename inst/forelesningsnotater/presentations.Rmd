...
plotwf <- data.frame(kov=kov,corr=r,w1=1-w, w2=w) %>%
...
\begin{equation}
Kor(r_a,r_b)=\frac{Kov(r_a,r_b)}{Std(r_a)Std(r_b)}
\end{equation}

- $Kor(r_a,r_b)=1$ (fullstendig avhengige)
- $Kor(r_a,r_b)=0$ (fullstendig uavhengige)
- $Kor(r_a,r_b)=-1$ (fullstendig motsatt avhengige)

Løser denne for $Kov(r_a,r_b)=Kor(r_a,r_b)Std(r_a)Std(r_b)$

Som gjør at vi kan skrive
\begin{equation}
Var(r_p)=w_1^2Var(r_1)+w^2_2Var(r_2)+2w_1w_2Kor(r_a,r_b)Std(r_a)Std(r_b)
\end{equation}
