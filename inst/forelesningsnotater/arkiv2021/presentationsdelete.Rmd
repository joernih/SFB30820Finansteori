...
- $D_t + TB_t$ (kontantdividende pluss betaling for tilbakekjøpte aksjer) kontantstrømmen som eierne tar *ut* av selskapet
- $EM_t$ (emisjonsbeløpet ved emisjon av aksjer) kontantstrømmen som eierne *tilfører* selskapet
...
1. Selskapene som ikke betaler dividende, er kjennetegnet ved sterk vekst og investeringstakt
...
1. Økt (redusert) uventet dividende vil medføre høyere (lavere) aksjekurs
```{r, echo=FALSE, out.width="40%", fig.cap="", fig.align="center"}
knitr::include_graphics(c("pensum/figurer-66.png"))
```
