...
$$
Var(r_p) = w_1^2\cdot 10 + (1-w_1)^2\cdot 18 \\
...
<div class="solution">
$$
P_0 = \frac{300\cdot 0.04}{(1+0.4)^{1}} + \frac{Mr_k}{(1+6)^{2}} + \frac{Mr_k}{(1+6)^{T}}+\frac{M}{(1+6)^T} \\
P_0 = \frac{300\cdot 0.04}{(1+0.4)^{1}} + \frac{Mr_k}{(1+6)^{2}} + \frac{Mr_k}{(1+6)^{T}}+\frac{M}{(1+6)^T} \\
P_0 = \frac{300\cdot 0.04}{(1+0.4)^{1}} + \frac{Mr_k}{(1+6)^{2}} + \frac{Mr_k}{(1+6)^{T}}+\frac{M}{(1+6)^T}
$$
</div>
...
<div class="solution">
$$
87.63=\frac{100}{(1+r)^3} 
$$
</div>

<div class="solution">
$$
87.63=\frac{100}{(1+r)^2} 
$$
</div>
