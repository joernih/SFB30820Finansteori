...
- Leveres inn: 26.10.2022 (Canvas og/eller postkassehylle)
  ...
  - Del II: som regneark (kan enten printes ut lastes opp som xlsx-fil) 
...
\frac{(1.005038)^2}{(1.015)^1}-1=`r 0.02627083`
$$
*Terminrente periode 3*
$$
_{2}f_{3}=\frac{(1+_{0}r_{3})^{3}}{(1+_{0}r_{2})^{2}} - 1
=\frac{(1.003356)^3}{(1.005038)^2}-1=`r 0.05354398`
$$
</div>
...
f23
# [1] 0.05354398
plot(x=c(1,2,3),y=c(f01,0.02627083,0.05354398), xlab="Periode", ylab="Rentenivå")
```
</div>
<div class="solution">
</div>
