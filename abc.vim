...
silent only
silent tabonly
cd ~/teaching/SFB30820Finansteori
...
exe 'vert 1resize ' . ((&columns * 213 + 135) / 271)
exe '2resize ' . ((&lines * 30 + 31) / 63)
exe 'vert 2resize ' . ((&columns * 57 + 135) / 271)
...
argglobal
balt inst/forelesningsnotater/neste2.Rmd
...
silent! normal! zE
let &fdl = &fdl
let s:l = 34 - ((18 * winheight(0) + 15) / 30)
...
wincmd w
argglobal
terminal ++curwin ++cols=57 ++rows=30 R
...
wincmd w
argglobal
if bufexists("vignettes/abc.Rmd") | buffer vignettes/abc.Rmd | else | edit vignettes/abc.Rmd | endif
balt index.Rmd
vnoremap <buffer> <silent> ,kn :call RKnit()
vnoremap <buffer> <silent> ,rd :call RSetWD()
vnoremap <buffer> <silent> ,ko :call RMakeRmd("odt_document")
...
wincmd w
argglobal
if bufexists("inst/arbeidskrav/arbeidskrav2021_F_L.Rmd") | buffer inst/arbeidskrav/arbeidskrav2021_F_L.Rmd | else | edit inst/arbeidskrav/arbeidskrav2021_F_L.Rmd | endif
balt vignettes/abc.Rmd
vnoremap <buffer> <silent> ,kn :call RKnit()
vnoremap <buffer> <silent> ,rd :call RSetWD()
vnoremap <buffer> <silent> ,ko :call RMakeRmd("odt_document")
vnoremap <buffer> <silent> ,kh :call RMakeRmd("html_document")
...
silent! normal! zE
let &fdl = &fdl
let s:l = 88 - ((28 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 88
...
tabnext 1
badd +30 index.Rmd
badd +1 inst/forelesningsnotater/neste2.Rmd
badd +1 inst/forelesningsnotater/læringsmaal.Rmd
badd +1 inst/forelesningsnotater/neste1.Rmd
badd +9 vignettes/abc.Rmd
badd +0 inst/arbeidskrav/arbeidskrav2021_F_L.Rmd
