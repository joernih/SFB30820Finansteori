...
%argdel
$argadd index.Rmd
edit inst/forelesningsnotater/læringsmaal.Rmd
...
silent! normal! zE
let &fdl = &fdl
let s:l = 77 - ((2 * winheight(0) + 27) / 55)
...
wincmd w
argglobal
if bufexists("inst/forelesningsnotater/neste1.Rmd") | buffer inst/forelesningsnotater/neste1.Rmd | else | edit inst/forelesningsnotater/neste1.Rmd | endif
balt inst/forelesningsnotater/læringsmaal.Rmd
vnoremap <buffer> <silent> ,kn :call RKnit()
vnoremap <buffer> <silent> ,rd :call RSetWD()
vnoremap <buffer> <silent> ,ko :call RMakeRmd("odt_document")
vnoremap <buffer> <silent> ,kh :call RMakeRmd("html_document")
...
wincmd w
argglobal
if bufexists("inst/forelesningsnotater/neste2.Rmd") | buffer inst/forelesningsnotater/neste2.Rmd | else | edit inst/forelesningsnotater/neste2.Rmd | endif
balt inst/forelesningsnotater/læringsmaal.Rmd
vnoremap <buffer> <silent> ,kn :call RKnit()
vnoremap <buffer> <silent> ,rd :call RSetWD()
vnoremap <buffer> <silent> ,ko :call RMakeRmd("odt_document")
...
tabnext 1
badd +25 index.Rmd
badd +17 inst/forelesningsnotater/neste1.Rmd
badd +59 inst/forelesningsnotater/neste2.Rmd
badd +77 inst/forelesningsnotater/læringsmaal.Rmd
