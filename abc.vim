...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 179 + 114) / 228)
exe 'vert 2resize ' . ((&columns * 48 + 114) / 228)
argglobal
...
wincmd w
argglobal
terminal ++curwin ++cols=48 ++rows=50 R
...
badd +10 vignettes/abc.Rmd
badd +89 inst/arbeidskrav/arbeidskrav2021_F_L.Rmd
