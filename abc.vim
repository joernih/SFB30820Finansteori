...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 71 + 64) / 129)
exe 'vert 2resize ' . ((&columns * 57 + 64) / 129)
...
wincmd w
argglobal
terminal ++curwin ++cols=57 ++rows=57 R
...
badd +0 ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/læringsmaal.Rmd
badd +52 ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/timeplan.R
