...
silent! normal! zE
let &fdl = &fdl
let s:l = 22 - ((11 * winheight(0) + 39) / 79)
...
wincmd w
argglobal
if bufexists("presentations.Rmd") | buffer presentations.Rmd | else | edit presentations.Rmd | endif
balt presentations.Rmd
nnoremap <buffer> <silent> ,rf :call StartR("R")
nnoremap <buffer> <silent> ,rc :call StartR("custom")
nnoremap <buffer> <silent> ,rq :call RQuit('nosave')
...
silent! normal! zE
let &fdl = &fdl
let s:l = 33 - ((32 * winheight(0) + 39) / 78)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 33
