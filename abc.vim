...
argglobal
%argdel
edit arbeidskrav/arbeidskrav2021_F.Rmd
...
exe 'vert 1resize ' . ((&columns * 260 + 159) / 318)
exe '2resize ' . ((&lines * 39 + 40) / 81)
exe 'vert 2resize ' . ((&columns * 57 + 159) / 318)
exe '3resize ' . ((&lines * 39 + 40) / 81)
tcd ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori
argglobal
balt ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/arbeidskrav/arbeidskrav2021_F.Rmd
...
silent! normal! zE
let &fdl = &fdl
let s:l = 74 - ((22 * winheight(0) + 19) / 39)
...
wincmd w
argglobal
terminal ++curwin ++cols=57 ++rows=39 R
...
wincmd w
argglobal
if bufexists("~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/presentations.Rmd") | buffer ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/presentations.Rmd | else | edit ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/presentations.Rmd | endif
balt ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/arbeidskrav/arbeidskrav2021_F.Rmd
vnoremap <buffer> <silent> ,kn :call RKnit()
vnoremap <buffer> <silent> ,rd :call RSetWD()
vnoremap <buffer> <silent> ,ko :call RMakeRmd("odt_document")
...
silent! normal! zE
let &fdl = &fdl
let s:l = 564 - ((19 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 564
...
exe '3resize ' . ((&lines * 39 + 40) / 81)
tabnext 1
badd +119 ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/arbeidskrav/arbeidskrav2021_F.Rmd
badd +0 ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/presentations.Rmd
