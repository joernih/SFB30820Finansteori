...
argglobal
%argdel
edit arbeidskrav/arbeidskrav2021_F_L.Rmd
...
exe 'vert 1resize ' . ((&columns * 176 + 117) / 234)
exe '2resize ' . ((&lines * 27 + 28) / 57)
exe 'vert 2resize ' . ((&columns * 176 + 117) / 234)
exe 'vert 3resize ' . ((&columns * 57 + 117) / 234)
argglobal
balt inst/forelesningsnotater/dagens.Rmd
...
wincmd w
argglobal
if bufexists("inst/forelesningsnotater/dagens.Rmd") | buffer inst/forelesningsnotater/dagens.Rmd | else | edit inst/forelesningsnotater/dagens.Rmd | endif
balt inst/forelesningsnotater/dagens.Rmd
vnoremap <buffer> <silent> ,kn :call RKnit()
vnoremap <buffer> <silent> ,rd :call RSetWD()
vnoremap <buffer> <silent> ,ko :call RMakeRmd("odt_document")
...
silent! normal! zE
let &fdl = &fdl
let s:l = 32 - ((14 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 32
...
wincmd w
argglobal
terminal ++curwin ++cols=57 ++rows=55 R
...
exe 'vert 3resize ' . ((&columns * 57 + 117) / 234)
tabnext 1
badd +33 inst/forelesningsnotater/dagens.Rmd
badd +0 arbeidskrav/arbeidskrav2021_F_L.Rmd
