...
beta_E <- 1
beta_K <- 1
w_E <- eval(parse(text='E/(E+G)'),list(E=E))
w_G <- eval(parse(text='G/(E+G)'),list(E=E))
k_E <- eval(parse(text='r_f+beta_E*(Er_m-r_f)'),list(E=E))
k_G <- eval(parse(text='r_f+beta_K*(Er_m-r_f)'),list(E=E))
...
*Terminrente periode 1*

1. Gi en tolkning av hva terminrenten forteller oss gitt at forutsetningen holder
