...
Erp, w1, w2, rf, rm, var1, var2, rho = sympy.symbols('Erp, w1, w2, rf, rm, var1, var2, rho')
Erp = w1*rf + w2*rm
Erp.subs([(w1,1),(w2,1),(rf,1),(rm,1)])
## Risk-lover investor
Varp = w1**2*var1+w2**2*var2+2*rho*var1**2*var2**2
Varp.subs([(w1,1),(w2,1),(var1,1),(var2,1),(rho,1)])
Stdp = Varp.subs([(w1,1),(w2,1),(var1,1),(var2,1),(rho,1)])**(1/2)
```
