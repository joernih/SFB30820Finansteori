...
solve(ERP.subs([(w1,0.80),(rf,0.04),(rm,0.07)]),Er_p)[0]
Varp = w1**2*var1+w2**2*var2+2*rho*var1**2*var2**2
Varp.subs([(w1,0.80),(w2,0.20),(var1,0),(var2,0.03**2),(rho,0)])
Stdp = Varp.subs([(w1,0.80),(w2,0.20),(var1,0),(var2,0.03**2),(rho,0)])**(1/2)
## Risk-lover investorene
w1 = sympy.solve(ERP,w1)[0].subs([(rf,0.04),(rm,0.07),(Er_p,0.085)])
w2 = 1-w1
Varp.subs([(w1,-0.5),(w2,1.5),(var1,0),(var2,0.03**2),(rho,0)])
```
...
reticulate::repl_python()
from sympy import solve, Eq, symbols, latex, simplify
Er_p, Er_m, r_f, beta_E, beta_G, rp, E, G, k_E, k_G, k_T, w_E, w_G = sympy.symbols('Er_p Er_m r_f beta_E beta_G rp E G k_E k_G k_T w_E w_G')
#1. Beregne vektene (markedsverdi) for egenkapital og gjeld
w_E=E/(E+G)
w_G=G/(E+G)
#2. Kapitalkostnad for egenkapital
k_E=r_f+beta_E*(Er_m-r_f)
#3
k_G=r_f+beta_G*(Er_m-r_f)
