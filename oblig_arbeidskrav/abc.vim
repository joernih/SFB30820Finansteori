...
silent only
silent tabonly
cd ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/oblig_arbeidskrav
...
exe 'vert 2resize ' . ((&columns * 99 + 78) / 157)
exe 'vert 3resize ' . ((&columns * 57 + 78) / 157)
tcd ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/oblig_arbeidskrav
argglobal
...
wincmd w
argglobal
if bufexists("~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/oblig_arbeidskrav/abc.R") | buffer ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/oblig_arbeidskrav/abc.R | else | edit ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/oblig_arbeidskrav/abc.R | endif
vnoremap <buffer> <silent> ,rd :call RSetWD()
nnoremap <buffer> <silent> ,rd :call RSetWD()
onoremap <buffer> <silent> ,rd :call RSetWD()
vnoremap <buffer> <silent> ,ko :call RMakeRmd("odt_document")
...
exe 'vert 3resize ' . ((&columns * 57 + 78) / 157)
tabnext 1
badd +4 ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/oblig_arbeidskrav/abc.R
