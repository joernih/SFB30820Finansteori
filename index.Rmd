...
# Nyheter
  ...
  - **Pga karrieredagen starter forelesningen da opp kl. 12.15 (kommer en kunngjøring om dette så fort 
    jeg har fått en bekreftelse på at dette er oppdatert i timeplanen.**
  - Vider utover vil det etter forelesningen bli satt av to timer (i samme rom som benyttet under forelesningen) til oppgaveløsning og veiledning.
