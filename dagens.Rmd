...
knitr::include_graphics(c("pensum/figurer-31.png",
			"pensum/figurer-32.png"))
```

```{r, echo=FALSE, out.width="50%", fig.cap=""}
knitr::include_graphics(c("pensum/figurer-33.png",
			"pensum/figurer-34.png"))
```
...
Vi started med sammenhengen mellom realrenten, nominal rente og inflasjon som er gitt ved
\begin{equation}
