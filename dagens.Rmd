...
Porteføljeteorien som vi har studert til nå bygger på eksplisitte forutsetninger om
...
Fra **eksempel 3.3l** i læreboka har vi at markedet består tre selskaper(1,2 og 3) og to investorer (A og B). Verdien på selskapene og etterspørselen i aksjemarkedet er gitt ved
...
radnr_ii <- c("Selskap 1",
	   ...
	   "Selskap 3",
	   "")
tils1 <- c(3000,9000,9000+3000,12000)
tils2 <- c(2000,6000,4000,0)
df_prosj_kontantstrøm <- data.frame(radnr_i,tils1,radnr_ii,tils2)
htmlTable(df_prosj_kontantstrøm, header=c("","","",""))
```

- Case 1: Investorene setter like stort beløp hvert selskap
	- $w=(12000/3,12000/3,12000/3)=(1/3,1/3,1/3)$
- Case 2: Investorene setter det *verdiverte* beløp i hvert selskap
	- $w=(12000/12000,12000/3,12000/3)=(1/3,1/3,1/3)$
...
Case 2 gir oss den *markedsporteføljen* (dvs. verdiveide)
...
### Empiri - markedsporteføljen (verdiveide)
