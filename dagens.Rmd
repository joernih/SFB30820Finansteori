...
- Den blå linjen viser kombinasjoner av investeringer i risikofritt alternativ og den effiseinte akjseporteføljen C
 - Til venstre for C, en andel av de oppsparte midlene de plaseres i banken 
 - Til høyre for C, ingen sparing og banklån benyttes til å finansiere kjøp i aksjeporteføljen

---

- Den grønn linjen viser kombinasjoner av investeringer i risikofritt alternativ og den effiseinte akjseporteføljen M
 - Til venstre for M, en andel av de oppsparte midlene plaseres i banken 
 - Til høyre for M, ingen sparing og banklån benyttes til å finansiere kjøp i aksjeporteføljen


Merk: Vi forutsetter her (1) ingen kredittrestriksjoner og at (2) sparerenten er lik utlåndsrenten


**Tofondsresultatet:**

1. Uansett graden av risikoaversjon, setter alle investorer sammen sin aksjeportefølje på nøyaktig samme måte.
1. Den enkelte investors risikoaversjon avgjør bare hvor mye som totalt skal satses på den risikoable komponenten framfor den risikofrie. Ikke sammesetningen av den risikable komponenten.

**Øvelse:** ... implisitt lagt til grunn

---

### Utledning av kapitalmarkedslinjen (kombinasjon av risikofri investering og markedsporteføljen M

Forventet avkastning for porteføljen er gitt ved 

\begin{equation}
E(r_p)=wr_f+(1-w)E(r_m) \end{equation}
...
Fra eksempel 3.1 har vi følgende opplysninger
...
Eksempel 3.2
- Vi har at investor A ønsker å plassere 80 prosent av formuen risikofritt
  -  $E(r_p)=0.8\cdot 0.04 0.2\cdot 0.07$ 
  -  $Var(r_p)=0.8^2\cdot 0 + 0.04 + 0.2^2 \cdot 0.07=0.00004$
  -  $Std(r_p)=\sqrt(0.00004)=0.06$
- Vi har at investor B ønsker at risikoen i porteføljen skal være på 8.5%
  -  $0.08=w\cdot 0.04 +(1-w)0.2\cdot 0.07 \Leftrightarrow w =-0.5$ og $1-w=1.5$ 
  -  $Var(r_p)=0.8^2\cdot 0 + 0.04 + 0.2^2 \cdot 0.07=0.00004$
  -  $Std(r_p)=\sqrt(0.00004)=0.06$
