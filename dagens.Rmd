...
av samtlige aksjer som inngår i markedsparteføljen (M). Formelt kan vi uttrykke dette som 
...
Skal nåverdi beslutning bli korrekt er det det siste vi trenger å beregne for å kunne fatte riktig beslutnign om justern nåverdi.
...
1. Diversifisert konglomerat også fornuftig når det gjelder selskapet? 
	- Dersom det kun påvirker nevneren, nei
	- Dersom det kun påvirker nevneren i justert nåverdi, ja
	
	
Markedsmakt vs. Kontantstrøm

Konglomerat (flere uavhengig ben å stå på)
...
- Gjennbruk av informasjon til å finne feilprisede aksjer vil ikke være mulig
...
**Spørsmål:** Ligger en antagelse om informasjonseffisiens til grunn for Statens Pensjonsfond (Oljefondet) investeringsstregi?
...
- *Sterk effisiens:* Halvsterk effisieint + *all* relevant informasjon (også innsideinformasjon)
...
- For at markedet skal være våre effisient må det *alltid* finnes investorer som tror at markedet ikke er effisient. Forsvinner den troen vil nemlig markedet bli inneffisient.
...
+ Evenen til å skille mellom systematisk og ikke systematisk risiko 
...
- I stor grad bygd på antagelsen om informasjonsoffisens  
...
Et kjennetegn ved alle disse metodene er at de ikke tilfredstiller *noen* av de tre egenskapene som tidligere ble ramset opp som styrken til KVM.
...
+ Nyttig risikoinformasjon siden en kan fokusere på usikkerhet i kontantstrømmen framfor en vansklig tolkbar nåverdi
+ ... 
+ ...
