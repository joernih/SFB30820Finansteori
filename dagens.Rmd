...
-2 \cdot 0.30 \cdot 0.40 \cdot 0.20 \cdot 0.40 \cdot 0.10 \\ 
=0.02722
\end{equation}
...
Vtarrow \infty kan forenkle dette, slik at vi står igjen med
...
- Større N (dvs. desto flere aksjer i porteføljen), desto mer dominerer porteføljevariansen av $(1-\frac{1}{N})$ framfor $\frac{1}{N}$
...
- $\beta_j>1$ - Mer følsom desto høyere verdi
- $\beta_j=1$ - Følsomhet lik markedsporteføljen 
- $\beta_j<1$ - Mindre følsom desto lavere veri
- $\beta_j=0$ - Risikofri aksje (null systematisk risiko)

Ved å utnytte sammenhengen om at $Kor()=\frac{Kov()}{Std()Std()}$, kan vi også skrive dette som
