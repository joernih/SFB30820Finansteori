...
- Gjeldsandel: (mellom 0 og 1) 

\begin{equation}
G/(G+E)
\end{equation}

- Gjeldsbeta (mellom 0 og $\infty$) 

\begin{equation}
G/E
\end{equation}

Vi vil gjøre et skille mellom disse to begrepene i formlene som vi nå skal se på, men i selve omtalen av bedriftens kapitalstruktur kan vi benytte dem om hver andre.
...
Senere se på hvordan disse kan diversifiseres ved bruk av finansielle instrumenter:  swapper.

**Eksempel 6.1:** Overskudd fem tilstander 
...
# Gjeldsgrad og verdi i perfekte markeder
