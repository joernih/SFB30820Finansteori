...
1. Dersom selskapet framover anslås å ha en evigvarende driftsresultat (OFR) på 100.000,-, hva er verdien på egenkapitalen og markedsprisen pr. aksje?
...
#htmlTable(dfn12,header=c("Sannsynlighet","Tilstandbeskrivelse","Prosjekt X","Prosjekt Y","Prosjekt Z"))
