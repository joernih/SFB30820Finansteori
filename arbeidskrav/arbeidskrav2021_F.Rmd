...
1. Hvilken forutsetning om finansiering må være oppfylt for at Spetalen kan gjenomføre sin strategi, og er det helt sikkert at han vil oppnå en høyere avkastning enn det som Lise sikter imot?
...
Frøken Bryn er et lite AS som holder til på Jessheim Storsenter. Selskapet har som har som spesialitet microblading permanent makeup av bryn.
I forbindelse med et oppkjøp er det estimert at selskapets egenkapitalbeta $\beta_E=0.83$ og gjeldsbeta lik \beta_G=0.1$. Den nominelle risikofrie renten i markedet på $2.5$ prosent, mens markedets risikopremie anslås til 5 prosent og Bryns skattesats er lik 15 prosent. Totalt sett har Bryn  200 aksjer utestående (pålydende 1,- per aksje) med beregnet markedspris lik 100.
