...
1. Ta utgangspunkt i at 4000,- av investeringsbeløpet investeres i selskap B, mens det resterende går til selskap A. Finn forventet avkastning, varians og standardavvik til porteføljen av de to selskapene.
...
100000/(1-k_E)
(100000/(1-k_E))/ant_aksj
```

1. Basert på disse opplysningene, klarer du å finne totalkapitalkostnaden til selskapet?
1. Dersom selskapet framover anslås å ha en evigvarende driftsresultat (OFR) på 100.000,-, hva er verdien til selskapet?
...
# [1] 8396.193
```
En null-kupong-obligasjon med 10 år til forfall har pålydende 5.000,- med årlig effektiv rente $r=0.06$. 
...
Den kortsiktige spotrenten $0_p_r$ for ett år fram i tid er ved 1.5 prosent. Vider kan vi notere for null-kupongrente-obligasjoner for 2, 3 og 4 år framover følgende opplysninger
```{r, echo=F}
...
1. Beregn terminpremien for 2 og 3 år framover i tid.
...
htmlTable::htmlTable(t(idf, header=c(1,2,3,4,5))
?htmlTable
```
