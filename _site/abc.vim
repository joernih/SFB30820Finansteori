...
exe 'vert 3resize ' . ((&columns * 158 + 118) / 237)
tcd ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori
argglobal
balt ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/læringsmaal.Rmd
...
wincmd w
argglobal
terminal ++curwin ++cols=78 ++rows=15 R
...
wincmd w
argglobal
if bufexists("~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/timeplan.R") | buffer ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/timeplan.R | else | edit ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/timeplan.R | endif
balt ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/abc.Rmd
nnoremap <buffer> <silent> ,rd :call RSetWD()
nnoremap <buffer> <silent> ,ko :call RMakeRmd("odt_document")
nnoremap <buffer> <silent> ,kh :call RMakeRmd("html_document")
nnoremap <buffer> <silent> ,kw :call RMakeRmd("word_document")
...
silent! normal! zE
let &fdl = &fdl
let s:l = 82 - ((30 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 82
...
normal! 0
tabnext
edit ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/arkiv/forelesning1_xar.Rmd
argglobal
balt ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/arkiv/forelesning1_xar.Rmd
nnoremap <buffer> <silent> ,rf :call StartR("R")
nnoremap <buffer> <silent> ,rc :call StartR("custom")
nnoremap <buffer> <silent> ,rq :call RQuit('nosave')
nnoremap <buffer> <silent> ,rw :call RQuit('save')
...
tabnext 1
set stal=1
badd +1 ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/presentations.Rmd
badd +1 ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/arkiv/forelesning1_xar.Rmd
badd +1 ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/læringsmaal.Rmd
badd +1 ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/timeplan.R
badd +1 ~/gitclones/homepageJIH/rprojects/teaching/SFB30820Finansteori/abc.Rmd
badd +0 ~/.vimrc
