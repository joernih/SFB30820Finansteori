...
$NV=\frac{10}{1+(0.02+0.07)}=\frac{10}{1.09}=9.174312$

Hva er sikkerhetsekvivalenten ved slutten av perioden?

$9.174312=\frac{X}{1+(0.02)}, dvs. X=9.174312*(1.02)=9.174312*(1.02)=9.357$
...
$Konstanstrømmen er sikker (lik 3 i begge perioder)$

Beregn forventet avkastning for hvert prosjekt.

$E(r_x)=0.30\cdot 3+0.70\cdot 3=$
$E(r_y)=0.30\cdot 5+0.70\cdot 12=$
$E(r_z)=0.30\cdot 9+0.70\cdot 12=$

Hva er forventet avkastning på en portefølje med like stort beløp investert i hvert av prosjektene?

$E(r_p)=1/3+1/3+1/3=1/3(+ + +)=1/3$
